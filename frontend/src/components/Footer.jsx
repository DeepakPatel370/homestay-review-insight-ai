...
// Custom inline SVG icons to prevent lucide export version mismatches
const TwitterIcon = () => (
...
export default function Footer() {
  ...
  const links = {
    product: [
      { name: 'Review Analyzer', path: '/dashboard' },
      { name: 'Sentiment Dashboard', path: '/dashboard' },
      { name: 'AI Generator', path: '/dashboard' },
    ],
    resources: [
      { name: 'Documentation', path: '/about' },
      { name: 'Guides', path: '/about' },
      { name: 'API Reference', path: '/about' },
    ],
    company: [
