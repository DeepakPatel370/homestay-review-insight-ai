  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sky-500/10 text-sky-400 text-xs font-semibold uppercase tracking-wider mb-4 border border-sky-500/10">
          <BookOpen className="w-3.5 h-3.5" />
          <span>Our Story & Vision</span>
        </div>
        <h1 className="text-4xl font-bold font-display text-white mb-6">About InsightStay AI</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
        <div className="glass-panel rounded-2xl p-8 border border-white/5 text-left">
          <div className="bg-sky-500/10 w-12 h-12 rounded-xl flex items-center justify-center text-sky-400 border border-sky-500/20 mb-6">
            <Compass className="w-6 h-6" />
          </div>
          <h2 className="text-xl font-bold font-display text-white mb-3">Our Mission</h2>
        ...
        <div className="glass-panel rounded-2xl p-8 border border-white/5 text-left">
          ...
          <h2 className="text-xl font-bold font-display text-white mb-3">Brand Integrity</h2>
          <p className="text-gray-400 font-light leading-relaxed text-sm">
      ...
      <div className="border-t border-white/5 pt-16 text-center">
        <h2 className="text-2xl font-bold font-display text-white mb-4">How It Works</h2>
        <p className="text-gray-400 font-light max-w-xl mx-auto mb-12 text-sm">
          A seamless flow designed to get reviews imported, parsed, and answered in just a few clicks.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          {steps.map((item, index) => (
            <div key={index} className="glass-card rounded-2xl p-6 border border-white/5 relative">
              <span className="absolute right-6 top-6 text-3xl font-extrabold text-slate-800/60 font-mono tracking-tighter">
                {item.step}
              </span>
              <h3 className="font-display font-bold text-white text-base mb-3 mt-4">
                {item.title}
              </h3>
